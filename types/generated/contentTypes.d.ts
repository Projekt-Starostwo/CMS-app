...
export interface ApiListaSzkolListaSzkol extends Struct.CollectionTypeSchema {
  collectionName: 'lista_szkols';
  info: {
    description: '';
    displayName: 'lista_szkol';
    pluralName: 'lista-szkols';
    singularName: 'lista-szkol';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lista-szkol.lista-szkol'
    > &
      Schema.Attribute.Private;
    lokalizacja_szkoly: Schema.Attribute.Component<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::lista-szkol.lista-szkol': ApiListaSzkolListaSzkol;
